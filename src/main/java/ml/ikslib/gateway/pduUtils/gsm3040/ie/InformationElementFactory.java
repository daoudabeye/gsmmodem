...
package ml.ikslib.gateway.pduUtils.gsm3040.ie;
...
public class InformationElementFactory
{
	...
	{
		PortInformationElement portInfo = new PortInformationElement(PortInformationElement.PORT_16BIT, destPort, srcPort);
		return portInfo;
	}
}
